<?php
    ...
    if(isset($_POST['submit'])){
        $msg = $config->insert_user_data($_POST['username'], $_POST['password']);
    }
    ...
    <div class="uk-container">
        ...
        <form action="" class="uk-padding-large" method="post">
            ...
            <div class="ui labeled button left" tabindex="0" aria-label="label">
              ...
              <div class="ui button">
               <input type="text" name="username" placeholder="Enter Username" class="uk-input">
              </div>
            </div>
            ...
            <div class="ui labeled button uk-margin-top left" tabindex="0" aria-label="label">
              ...
              <div class="ui button">
               <input type="password" name="password" placeholder="Enter Password" class="uk-input">
              </div>
            </div>

            <button name="submit" class="uk-button uk-button-primary uk-margin-top">Create</button>
